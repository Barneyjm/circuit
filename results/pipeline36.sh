...
#   STAGE="data/hard_tier_train.jsonl data/hard_tier_eval.jsonl data/v2_types_train.jsonl data/v2_types_eval.jsonl data/v21_types_train.jsonl data/v21_types_eval.jsonl data/cf_train.jsonl data/cf_eval.jsonl data/unseen_eval.jsonl data/grid_eval.jsonl data/hf_eval.jsonl data/cmdiy_eval.jsonl"
set -u
...
for f in hard_tier_train hard_tier_eval v2_types_train v2_types_eval v21_types_train v21_types_eval cf_train cf_eval unseen_eval grid_eval hf_eval cmdiy_eval grounded_tools_eval water_calls; do
...
for pair in "v21_types_eval v21" "cf_eval cf" "v2_types_eval v2" "hard_tier_eval hard" "unseen_eval unseen" "grounded_tools_eval gt" "grid_eval grid" "hf_eval hf" "water_calls water" "cmdiy_eval cmdiy"; do
  set -- $pair
